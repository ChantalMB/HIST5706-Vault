...
+  Imagine using this for heritage buildings/house --> enter heritage house, open phone, and situate the artifacts otherwise on display elsewhere in the place where they originally would be in that home (aka make the house look "lived in" by combining photogrammetry and AR)